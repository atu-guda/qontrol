...
class TQSearcher : public TMiso  {
 ...
 protected:
   ...
   // F
   PRM_LIST( F_type,    0,    "F t&ype",     "Quality type", "enum=QualType\nsep=block" );
   ...
   PRM_DOUBLE( qr_l,  efInner, "qr_l", "Relative y left point = q_l-q_c", "" );
   PRM_DOUBLE( qr_r,  efInner, "qr_r", "Relative y right point = q_r-q_c", "" );
